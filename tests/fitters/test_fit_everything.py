...
def test_Fit_Everything():
    ...
    assert_allclose(MLE._Fit_Everything__Weibull_3P_params.alpha, 0.5796887225805948, rtol=rtol, atol=atol)
    assert_allclose(MLE._Fit_Everything__Weibull_3P_params.beta, 4.205258710807067, rtol=rtol, atol=atol)
    assert_allclose(MLE._Fit_Everything__Weibull_3P_params.gamma, 0, rtol=rtol, atol=atol)
    assert_allclose(MLE._Fit_Everything__Weibull_3P_params.AICc, 24.571493772983473, rtol=rtol, atol=atol)
    assert_allclose(MLE._Fit_Everything__Weibull_3P_params.BIC, 34.343996893035744, rtol=rtol, atol=atol)
    assert_allclose(MLE._Fit_Everything__Weibull_3P_params.loglik, -9.224522396695818, rtol=rtol, atol=atol)
    assert_allclose(MLE._Fit_Everything__Weibull_3P_params.AD, 543.31193295208, rtol=rtol, atol=atol)
    ...
    assert_allclose(LS._Fit_Everything__Weibull_3P_params.alpha, 0.5796887225805948, rtol=rtol, atol=atol)
    assert_allclose(LS._Fit_Everything__Weibull_3P_params.beta, 4.205258710807067, rtol=rtol, atol=atol)
    assert_allclose(LS._Fit_Everything__Weibull_3P_params.gamma, 0, rtol=rtol, atol=atol)
    assert_allclose(LS._Fit_Everything__Weibull_3P_params.AICc, 24.571493772983473, rtol=rtol, atol=atol)
    assert_allclose(LS._Fit_Everything__Weibull_3P_params.BIC, 34.343996893035744, rtol=rtol, atol=atol)
    assert_allclose(LS._Fit_Everything__Weibull_3P_params.loglik, -9.224522396695818, rtol=rtol, atol=atol)
    assert_allclose(LS._Fit_Everything__Weibull_3P_params.AD, 543.31193295208, rtol=rtol, atol=atol)
